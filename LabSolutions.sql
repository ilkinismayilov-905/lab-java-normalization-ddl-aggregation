...
INSERT INTO articles (article_id, author_id, title, word_count, views) VALUES
    (1,3,'Modern Paint Trends',900,50),
    (2,2,'Decor Ideas for Small Rooms',1200,300),
    (3,1,'Trending Accessories 2026',1100,250),
    (4,1,'Texture Design Guide',800,60),
    (5,2,'Kitchen Makeover Tips',1300,400),
    (6,1,'DIY Art Projects',1050,220),
    (7,3,'Wood Floor Restoration Guide',1600,8000);
