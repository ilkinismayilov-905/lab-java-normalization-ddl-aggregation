...
VALUES (1, 3, 'Best Paint Colors', 814, 14),
...
INSERT INTO flights (flight_id, flight_number, aircraft_id, flight_mileage)
VALUES (1, 'DL143', 1, 1351),
       (2, 'DL122', 2, 4370),
       (3, 'DL53', 3, 2078),
       (4, 'DL222', 3, 1765),
       (5, 'DL37', 1, 531);

INSERT INTO customers (customer_id, name, status, total_mileage)
